...
@section('full_title', 'Заказать создание песни из стихов с помощью ИИ — от 600 ₽')
@section('meta_description', 'Оформите заказ: пришлите ваши стихи или текст, выберите тариф и получите готовую песню, созданную с помощью искусственного интеллекта. От 600 ₽, результат за 1–2 часа.')
@section('keywords', 'заказать песню из стихов, создать песню онлайн, сгенерировать песню ИИ, превратить стихи в песню онлайн, создание песни из текста')
