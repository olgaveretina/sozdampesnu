...
@section('full_title', 'Заказать песню из ваших стихов — 1000 ₽, результат от 1 часа')
@section('meta_description', 'Заполните форму, пришлите стихи и получите профессиональную песню. Наша команда подберёт стиль, мелодию и аранжировку. Оплата онлайн, результат от 1 часа. Безопасно — гарантия возврата.')
@section('keywords', 'заказать песню из стихов, создать песню онлайн, песня из текста на заказ, превратить стихи в песню, создание песни ИИ, песня в подарок заказать')
