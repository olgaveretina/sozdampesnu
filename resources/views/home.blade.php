        ...
        <div class="card h-100 shadow-sm border-warning">
            <div class="card-body d-flex flex-column">
                ...
                <ul class="list-unstyled small mt-2">
                    ...
                    <li>📌 Помощь в публикации: +1500</li>
                </ul>
                <div class="mt-auto">
    ...
    <div class="col-md-4">
        <div class="card h-100 shadow-sm border-warning">
            <div class="card-body d-flex flex-column">
                ...
                <ul class="list-unstyled small mt-2">
                    <li>✅ 4 лучших варианта от ИИ</li>
                    <li>✅ Срок: от 2 часов до 2 дней</li>
                    <li>✅ Мы послушаем и доработаем</li>
                    <li>📌 Правки по вашим инструкциям: +400 руб.</li>
                    <li>📌 Помощь в публикации: +1500</li>
                </ul>
                <div class="mt-auto">
    ...
    <div class="col-md-4">
        <div class="card h-100 shadow-sm border-warning">
            <div class="card-body d-flex flex-column">
                ...
                <p class="text-muted small">Доработаем песню и поможем опубликовать на Яндекс Музыке, VK музыке и других площадках</p>
                <ul class="list-unstyled small mt-2">
                    <li>✅ 4 лучших варианта от ИИ с нашей доработкой</li>
                    <li>✅ Обложка для площадок</li>
                    <li>✅ Сопроводим на этапе публикации</li>
                    <li>✅ Доход от прослушиваний — ваш</li>
                    <li>📌 Правки по вашим инструкциям: +400 руб.</li>
                    <li>📌 Сервис публикации возьмет дополнительно 3 600 руб.</li>
